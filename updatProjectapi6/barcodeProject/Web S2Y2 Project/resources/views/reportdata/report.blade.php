    ...
    $.ajaxSetup({
      ...
      $(document).ready(function(){
        $("#btnsave").click(function(){
            var dateform=$("#searchdate").val();
            var dateto=$("#searchdateto").val();
            $.post('/search-excate',{
            datepushform:dateform,
           datepushto:dateto,
            },function(result){
               if(result==1){
                 $(document).ready(function(){
  ...
  <main id="main" class="main">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col">
                    Form Date:
                    <input type="date" name="txtfdate" id="txtfdate" class="form-control">
            </div>
            <div class="col">
                    To Date:
...
<div class="container">
        <table class="table datatable">
            ...
            <tbody>
                @foreach($polist as $poObj)
                <tr scope="row">
                    <td><a href="#">{{$poObj->pocode}}</a></td>
                    <td>{{$poObj->date}}</td>
                    <td>{{$poObj->dis}}</td>
                    <td>{{$poObj->tax}}</td>
                    <td>{{$poObj->total}}</td>
