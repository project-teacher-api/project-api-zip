                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table datatable" id="tbluser">
                            ...
                            <td>  {{$obj->  price}}</td>
                            {{-- dom.js --}}
                            <td>  <a href="#" class="update btn btn-secondary btn-sm" data-bs-toggle="modal" data-bs-target="#basicModalone">Edite </a> | <a href="#" class="del btn btn-danger btn-sm" data-bs-toggle="modal" data-bs-target="#basicModal">delect</a></td>
                            </tr>
                            @endforeach
                            </tbody>
                        </table>
